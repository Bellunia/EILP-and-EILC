...
public class tripleCorrection {
    ...
    public static void main(String[] args) throws Exception {
        new tripleCorrection().TCA_test();
        new tripleCorrection().countQuantity();
        ...
        new tripleCorrection().correctionCompareProbability(expertAnalysisPath, expertAnalysisProbability);
    }
