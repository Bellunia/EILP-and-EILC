...
public class FactIndexer {
	...
	private Map<String, Set<String>> x2TSet;//xto type sets
	...
	public void indexFact(String[] parts, long frequency) {
		...
		//if (!parts[1].equals("type")) {//type --old
	...
	public boolean checkXpy(String xpy) { return xpy2Frequency.containsKey(xpy); }
