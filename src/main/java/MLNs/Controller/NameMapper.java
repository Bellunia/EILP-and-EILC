...
public class NameMapper {
	...
	public void addEntClass(String entName, String className) {
		...
		this.addRelationship(RDF_TYPE_NAME, entName, Type.ENTITY + "-" + className.substring(ProbKBData.CLS_LENGTH));
		// add rdf:type owl:Thing
		this.addRelationship(RDF_TYPE_NAME, entName, Type.ENTITY + "-" + OWL_THING_NAME.substring(ProbKBData.CLS_LENGTH));
	}
