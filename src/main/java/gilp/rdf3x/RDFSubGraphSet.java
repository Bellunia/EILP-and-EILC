...
public class RDFSubGraphSet {
	private HashSet<RDFPredicate> _predicates;
	private HashSet<RDFSubGraph> _sub_graphs;
	private int[][] _join_conditions;

	public RDFSubGraphSet() {
		_predicates = new HashSet<RDFPredicate>();
		_sub_graphs = new HashSet<RDFSubGraph>();
	}

	public void setPredicates(HashSet<RDFPredicate> preds) {
	...
	public HashSet<RDFPredicate> getPredicates() {
		return this._predicates;
	}

	public HashSet<RDFSubGraph> getSubGraphs() {

		return this._sub_graphs;
	}

	public HashSet<Triple> getAllTriples() {
		HashSet<Triple> listRlts = new HashSet<Triple>();
 ...
 //join two sets of twigs @sg_set1 and @sg_set2
	...
	public static RDFSubGraphSet joinTwigSets(RDFSubGraphSet sg_set1, int joinPre1,
		...
		HashSet<RDFPredicate> rlt_predicates = new HashSet<RDFPredicate>();
