...
//					o1 = o;
	...
	static void combineDBpediaData() throws Exception {

		BufferedWriter writer1 = null;

		writer1 = new BufferedWriter(new FileWriter("/media/wy/wu/data/all_Data.tsv"));

		File dir = new File("/media/wy/wu/data-dbpedia-2020/dbpedia-2020/");
	...
	static void preprocessSingleData() throws Exception {
		...
		writer1 = new BufferedWriter(new FileWriter("/home/wy/Downloads/data/yagoWikidataInstances1.tsv"));
		...
		// BufferedWriter writer = null;
		File dir = new File("/home/wy/Downloads/data/yagoWikidataInstances.tsv");
